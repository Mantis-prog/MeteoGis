...
public class Controller {
        ...
        buttonSearch.setOnAction(event -> {
            ...
            if (!getUserCity.equals("")) {
                ...
                if (!output.isEmpty()) {
                    ...
                    nameTemperature.setText("Температура: " + obj.getJSONObject("main").getDouble("temp") + " C");
                    nameFeeling.setText("Ощущается: " + obj.getJSONObject("main").getDouble("feels_like") + " C");
                    nameMax.setText("Максимум: " + obj.getJSONObject("main").getDouble("temp_max") + " C");
                    nameMin.setText("Минимум: " + obj.getJSONObject("main").getDouble("temp_min") + " C");
                    Pressure.setText("Давление: " + obj.getJSONObject("main").getDouble("pressure") + " Па");
                    Wind.setText("Скорость ветра: " + obj.getJSONObject("wind").getDouble("speed") + " м/с");
    ...
    private static String getUrlContent(String urlAdress) {
        ...
        try {
            ...
            //Обработка ошибки неправильного воода названия города
